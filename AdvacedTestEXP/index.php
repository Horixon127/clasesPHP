...
<head>
    ...
    <title>AdvancedTestEXP.com</title>
        ...
        <div class="card-body">
            <?php
                if (isset($_GET['confirm'])) {
                    ...
                    if ($_GET['confirm'] === "3") {
                        echo '<div class="alert alert-dark" role="alert"> <h6>Este Usuario Ya Esta Registrado<h6> </div>';
                    }
                }
        
            ?>
            <form action="./config/insercionMQ.php" method="POST">
